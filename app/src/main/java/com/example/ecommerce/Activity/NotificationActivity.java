...
import com.example.ecommerce.databinding.ActivityNotificationBinding;
...
public class NotificationActivity extends AppCompatActivity {
    ...
    private void TopBrand()
    {
        ...
        binding.rvNotification.setAdapter(new TrackProductAdapter(this,arrayList_top_brand));
